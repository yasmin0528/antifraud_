...
def build_aml_ca1_cache(processed_path: str, cache_path: str, k: int = 10) -> Dict:
...
def load_or_build_aml_ca1_cache(
    ...
    if os.path.exists(cache_path):
        ...
        if not valid:
            cache = None
    if cache is None:
        cache = build_aml_ca1_cache(processed_path, cache_path, k)
